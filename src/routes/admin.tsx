...
import { Shield, BarChart3, Film, Tag, Users, Sparkles } from "lucide-react";
...
const TABS: Array<{ to: "/admin" | "/admin/videos" | "/admin/deals" | "/admin/users" | "/admin/discoveries"; label: string; icon: typeof BarChart3; exact?: boolean }> = [
