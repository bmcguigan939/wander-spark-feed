...
function CreatorAgreementPage() {
  return (
    <LegalPage title="Creator Agreement" updated="November 2026">
      ...
      <ul>
        <li><strong>Founding Creator</strong> (first 500 creators): <strong>50%</strong> of the net pool — locked for life.</li>
        <li><strong>Power Creator</strong> (rolling 12-month gross booking value ≥ £25,000): <strong>50%</strong> of the net pool — locked for life once you cross the threshold.</li>
        ...
        <li><strong>Mature Creator</strong> (month 19+): 30% of the net pool, unless your rolling 12-month volume keeps you in the Power tier.</li>
      </ul>
