...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Travidz — Post travel videos, get paid when people book" },
      { property: "og:description", content: "Travidz turns your travel videos into income. Tag the spot, drop the link, earn 11% on every booking." },
      { name: "twitter:description", content: "Travidz turns your travel videos into income. Tag the spot, drop the link, earn 11% on every booking." },
      { property: "og:image", content: "https://www.travidz.com/og-cover.jpg" },
      { property: "og:image:width", content: "1216" },
      { property: "og:image:height", content: "640" },
      { name: "twitter:image", content: "https://www.travidz.com/og-cover.jpg" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://www.travidz.com/icon-512.png",
          description:
            "Travidz turns travel videos into income for creators. Viewers discover spots through real short videos and book directly.",
        }),
      },
    ],
  }),
