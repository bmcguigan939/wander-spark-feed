        ...
        {deal && (
          <>
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              <Stat icon={Eye} label="Clicks" value={totals?.clicks ?? 0} sub={delta >= 0 ? `+${delta}` : `${delta}`} />
              <Stat icon={Users} label="Unique" value={totals?.uniqueUsers ?? 0} />
              <Stat icon={Eye} label="All-time" value={deal.click_count} />
            </div>
                ...
                <ul className="space-y-2">
                  {topVideos.map((v) => (
                    ...
                    >
                      ...
                      <div className="text-sm font-semibold">{v.clicks}</div>
                    </li>
                  ))}
                </ul>
              )}
